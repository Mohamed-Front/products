<template>
  <div class="flex flex-col lg:flex-row min-h-[75vh] m-auto">
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-sm text-gray-500 truncate">
              {{ $t('auth.pharmacy_description') }}
            </p>
          </div>
        </div>

        <!-- Storehouse Registration Card -->
        <div
...
const continueToRegistration = () => {
  ...
  if (selectedType.value === 'pharmacy') {
    router.push({ name: 'register-pharmacy' })
  } else {
    router.push({ name: 'register-storehouse' })
  }
}
</script>
